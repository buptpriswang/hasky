...
#   \Description   sorting experiments
# ==============================================================================
...
flags.DEFINE_integer('num_numbers', 15, 'Number of numbers to sort.  ')
...
with tf.variable_scope('main') as scope:
  pointer = PointerNetwork(FLAGS.num_numbers, FLAGS.batch_size, FLAGS.rnn_size, FLAGS.num_attention_steps)
...
def gen_feed_dict():
   encoder_inputs, decoder_inputs, decoder_targets = data_generator.next_batch(
     FLAGS.batch_size, FLAGS.num_numbers)
