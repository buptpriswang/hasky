...
class TextPredictor(object):
  def __init__(self, model_dir, vocab_path, image_checkpoint_path=None, image_model_name='InceptionResnetV2', sess=None):
    ...
    self.predictor = melt.TextPredictor(model_dir, sess=sess)
