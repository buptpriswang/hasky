...
flags.DEFINE_string('all_text_strs', '/home/gezi/new/temp/image-caption/lijiaoshou/tfrecord/char/valid/distinct_text_strs.npy', '')
flags.DEFINE_string('all_texts', '/home/gezi/new/temp/image-caption/lijiaoshou/tfrecord/char/valid/distinct_texts.npy', '')
...
def run():
  ...
  for i, line in enumerate(open(FLAGS.image_file)):
    ...
    word_ids_list = np.array([gezi.nppad(text, TEXT_MAX_WORDS) for text in word_ids_list])
