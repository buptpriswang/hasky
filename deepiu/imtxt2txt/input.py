...
try:
  import conf
  from conf import IMAGE_FEATURE_LEN,TEXT_MAX_WORDS, INPUT_TEXT_MAX_WORDS
except Exception:
  from deepiu.image_caption.conf import IMAGE_FEATURE_LEN, TEXT_MAX_WORDS, INPUT_TEXT_MAX_WORDS
...
def decode_sequence_example(example):
  ...
  features, sequence_features = tf.parse_single_sequence_example(example, 
                                              ...
                                              sequence_features={
                                                 ...
                                                 'input_text': tf.FixedLenSequenceFeature([], dtype=tf.int64)
                                                })
  ...
  input_text_str = features['input_text_str']
  input_text = sequence_features['input_text']
