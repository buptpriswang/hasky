...
flags.DEFINE_string('model_dir', '/home/gezi/new/temp/imtxt_keyword/model/imtxt2txt/', '')
flags.DEFINE_string('vocab', '/home/gezi/new/temp/imtxt_keyword/tfrecord/seq-basic/vocab.txt', 'vocabulary file')

flags.DEFINE_string('image_feature_name_', 'imtxt2txt/model_init_1/image_feature:0', 'model_init_1 because predictor after trainer init')
flags.DEFINE_string('text_name', 'imtxt2txt/model_init_1/text:0', 'model_init_1 because predictor after trainer init')
flags.DEFINE_string('input_text_name', 'imtxt2txt/model_init_1/input_text:0', 'model_init_1 because predictor after trainer init')
...
flags.DEFINE_integer('batch_size_', 1000, '')
...
import conf
from conf import INPUT_TEXT_MAX_WORDS, TEXT_MAX_WORDS, NUM_RESERVED_IDS, ENCODE_UNK
